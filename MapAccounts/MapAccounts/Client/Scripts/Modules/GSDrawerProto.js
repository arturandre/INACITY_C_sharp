        ...
        for (var j = 0; j < trechos.length; j++) {
            ...
            for (var i = 0; i < points.length - 1; i++) {
                ...
                if (!!pano && pano.length === 22) {
                    ...
                    var picture = PictureDTO.initialize(pictureIndex++, point.PanoramaDTO.frontAngle, null, finalURL,
                        PointDTO.initialize(-1, point.lat, point.lng), null);
                    //picture.imageURI = ;
                    //picture.heading = ;
            ...
            if (!!lastPano) {
                ...
                picture = PictureDTO.initialize(pictureIndex++, lastPoint.PanoramaDTO.frontAngle, null, finalURL,
                        PointDTO.initialize(-1, lastPoint.lat, lastPoint.lng), null);
