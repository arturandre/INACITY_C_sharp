...
GSPanoramaMiner.prototype.Compare = function (s, e) {
    ...
    if (s >= e) {
        this.getPanoramaId(this.concatenatedPoints[s], function (data, status) {
            if (status === "OK") {
                if (GSPanoramaMiner.stringDistance(GSPanoramaMiner.normalizeStreetName(data.location.description), GSPanoramaMiner.normalizeStreetName(this.currentStreet.Name)) < 0.9) {
